...
class Line(object):
    ...
    def slope(self):
        ...
        #        They include the Example in the above doc-string.
        # --------------------------------------------------------------
        if not (self.end.x == self.start.x):
    ...
    def line_plus(self, other_line):
        ...
        #        They include the Example in the above doc-string.
        # --------------------------------------------------------------
        newLineStart = self.start.plus(other_line.start)
        newLineEnd = self.end.plus(other_line.end)
    ...
    def line_minus(self, other_line):
        ...
        #        They include the Example in the above doc-string.
        # --------------------------------------------------------------
        newLineStart = self.start.minus(other_line.start)
        newLineEnd = self.end.minus(other_line.end)
        return Line(newLineStart, newLineEnd)
